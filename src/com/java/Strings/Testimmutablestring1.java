...
public class Testimmutablestring1 {
	 ...
	 * 
	 * 
	 * Heap: The immutability of String helps to minimize the usage in the heap
	 * memory. When we try to declare a new String object, the JVM checks whether
	 * the value already exists in the String pool or not. If it exists, the same
	 * value is assigned to the new object. This feature allows Java to use the heap
	 * space efficiently.
	 * 
	 * 
	 */
