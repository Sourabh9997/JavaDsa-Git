...
public class WrapperExample1 {
	 ...
	 * java.util package: The java.util package provides
	 * the utility classes to deal with objects. 
	 * Collection Framework: Java
	 * collection framework works with objects only. All classes of the collection
	 * framework (ArrayList, LinkedList, Vector, HashSet, LinkedHashSet, TreeSet,
